	...
	<head>
		...
		<script type="text/javascript">
			...
			function initialize() {
				...
				// CHF 10/14/2014 - this preloads markers before modal window.  Also Added this to #seemap below.
				addMarkers(markers);
	...
	<body>
				...
				<?php
					...
					foreach($types as $type) {
						if($type[0] != "event") {
							echo $var;
							if ($var == 'Bob') {
								$markers = pg_query("SELECT * FROM places WHERE approved='1' AND type='$type[1]' AND hiring = '2' ORDER BY title");
							} else {
								$markers = pg_query("SELECT * FROM places WHERE approved='1' AND type='$type[1]' ORDER BY title");
							}	
						...
						//$markers_total = pg_num_rows($hiring);	
		...
		<div class="modal hide" id="modal_info">
			...
			<div class="modal-body">
				...
				<p>Want to know where to start? Hereâ€™s a few ways you can use this map:
				<ul>
					...
					<li>Add your company. Donâ€™t see your business currently listed? Keep our map fresh and submit your information here.</li>
				</ul>
				</p>
			 ...
			 -->
<p>Welcome! We built this map to help build connections in Raleighâ€™s growing startup community.  Raleigh has transformed over the last few years into a city that fosters innovation, collaboration, and entrepreneurship and this map sets out to showcase that transformation. From Technology and Life Sciences, to Design and Consumer Products, Raleigh is expanding quickly across a wide variety of sectors.</p>
...
<li>Add your company. Donâ€™t see your business currently listed? Keep our map fresh and submit your information here.
<ul>
</p>
<p>Questions? Feedback? Connect with us: <a href="http://www.raleigh4u.com/contact/" target="_blank">http://www.raleigh4u.com/contact/</a></p>
